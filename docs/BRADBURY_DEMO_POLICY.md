...
local tests can use bounded clocks. If the optional canonical live Bradbury
five-bid demo is ever resumed, it must use `7200` seconds
(`tools/demo_policy.py`), not the minimum. Bradbury
