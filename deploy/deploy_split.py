...
COMPONENTS = (
    ...
    ("evaluator", ROOT / "contracts/tender_council_evaluator.py", ROOT / "artifacts/tender_council_evaluator_deployable.py", ["<CORE_ADDRESS>", "tendercouncil.evaluator.v1"]),
)
...
def main() -> None:
    ...
    manifest = {
        ...
        "ordered_steps": [
            ...
            "verify Core binding address/version/source hash",
        ],
        "components": records,
        "binding": {
            "method": "bind_evaluator(evaluator_address, evaluator_version, evaluator_source_hash)",
            "one_time": True,
